...
<html lang="en">
  ...
  <div class="slider-wrapper"><!-- innermost wrapper element -->
    <img src="<?=base_url()?>assets/img/1.jpg" alt="First" class="slide" /><!-- slides -->
    <img src="<?=base_url()?>assets/img/2.jpg" alt="Second" class="slide" />
    <img src="<?=base_url()?>assets/img/3.jpg" alt="Third" class="slide" />
  </div>
  </div>  
  </div>
  </div>
  ...
  <div style="text-align: center; padding-top: 200px; padding-bottom: 200px;">
    ...
    <a href="<?=base_url()?>index.php/wisuda/persyaratan"><h3>PERSYARATAN</h3></a>
  </div>
  </div>
  </div>
  ...
  <div style="text-align: center; padding-top: 200px; padding-bottom: 200px;">
    ...
    <a href="<?=base_url()?>index.php/wisuda/panduan"><h3>PANDUAN PENDAFTARAN</h3></a>  
  </div>
  </div>
  </div>
  ...
  <div style="text-align: center; padding-top: 220px; padding-bottom: 220px;">
    ...
    <a href="<?=base_url()?>index.php/wisuda/pengumuman"><h3>PENGUMUMAN</h3></a>
  </div> 
  </div> 
  </div>
  ...
  <div style="text-align: center; padding-top: 220px; padding-bottom: 220px;">
    ...
    <a href="<?=base_url()?>index.php/wisuda/page_login"><h3>LOGIN</h3></a>
  </div> 
  </div> 
  </div>    
