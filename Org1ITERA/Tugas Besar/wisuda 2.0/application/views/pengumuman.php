  ...
  <!---->
      ...
      <!--<div class="row content">
          <link rel="stylesheet" type="text/css" href="pengumuman.css">
              <div class="A">
                   <a href="<?=base_url()?>index.php/wisuda/Wisuda Pertama ITERA" >
                   <img src="<?=base_url()?>assets/img/wisuda.jpg" style="width:304px;height:228px;">
                   Wisudawan/wati Pertama ITERA
                   <pre>Jum'at(7/10/2016), adalah hari bersejarah bagi Institut Teknologi Sumatera (ITERA)<br> karena pertama kalinya menggelar wisuda mahasiswa.</pre></a>
      ...
      <?php 
        ...
        foreach ($list as $key => $value) {
          # code...
          echo "<li><a href='".base_url()."index.php/wisuda/viewArtikel?id=".$value['id']."'> ".$value['judul']."</a></li>";
        }
        echo "</ul>";
       ?>
      </div>
