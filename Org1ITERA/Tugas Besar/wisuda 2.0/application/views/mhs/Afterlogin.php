...
<html lang="en">
  ...
  <body>
    ...
    <ul>
      ...
      <li><a href="<?=base_url()?>index.php/wisuda/persyaratan">Persyaratan</a></li>
      <li><a href="#">Panduan Pendaftaran</a></li>
	    <li><a href="<?=base_url()?>index.php/wisuda/pengumuman">Pengumuman</a></li>

      <li>Hi! <?php echo $_SESSION['nama']; ?></li>
    </ul>
    </nav>
    </div>
  <!---->
      ...
      <div class="row">
        <div class="col-sm-3">
          <div class="row">
          <img src="<?=base_url(); echo "assets/imgmhs/".$_SESSION['foto'];?>" class="col-sm-12">
          </div>
          <div class="row" style="margin-top: 10px;">
            <div class="col-sm-12">
               <div class="list-group">
                  ...
                  <li class="list-group-item"><a href="<?=base_url()?>index.php/wisuda/validasi_pembayaran_page" style="color: #555; text-decoration: none; display: block;">Pembayaran dan Validasi</a></li>

                   <li class="list-group-item"><a href="<?=base_url()?>index.php/wisuda/cetakbukti_page/<?php echo $nim;?>" style="color: #555; text-decoration: none; display: block;">Cetak Bukti</a></li>
        ...
        <div class="col-sm-6">
         <div class="list-group">
           <ul style="list-style-type: none;">
             <li class="list-group-item"><?php echo '<strong>Nama : </strong>'.  $_SESSION['nama']; ?></li>
             <li class="list-group-item"><?php echo '<strong>Nim : </strong>'.  $nim; ?></li>
              <li class="list-group-item">
               ...
               <li class="list-group-item"><?php echo '<strong>Sidang TA 1 : </strong>'.$sidangta_1;?></li>
               <li class="list-group-item"><?php echo '<strong>Sidang TA 2 : </strong>'.$sidangta_2;?></li>
               <div style="margin-top: 10px;" class="h4"> Note :</div>
                 <li>-Jika anda belum menyelesaikan kuliah praktik, sidang tugas akhir 1 dan sidang tugas akhir 2 maka anda belum bisa mendaftar wisuda</li>
           </ul>
         </div>
        </div>
      </div>
