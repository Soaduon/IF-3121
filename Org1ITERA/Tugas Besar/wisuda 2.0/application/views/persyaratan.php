    ...
    <ul>
     ...
     <?php 
      if($_SESSION['logged_in']!=1){
        ...
        echo  "<li><a href='".base_url()."index.php/wisuda/page_login'>Hi! ".$_SESSION['nama']."</a></li>";
      }
      ?>
      ...
      <h3>SYARAT KELULUSAN DAN WISUDA</h3><br>
      <h4>Syarat Kelulusan Program Pendidikan Sarjana</h4><br>
      <p>Mahasiswa dinyatakan lulus Program Sarjana apabila memenuhi persyaratan berikut:</p><br>
      <ul>
        <li>Telah menyelesaikan sekurang-kurangnya sejumlah 144-148 sks yang diwajibkan</li>
        <li>IPK minimal 2,00</li>
        <li>Nilai mata kuliah wajib minimal C</li>
        <li>Jumlah SKS dengan nilai D tidak lebih dari 10% jumlah SKS total</li>
        <li>Tidak ada nilai E</li>
        <li>Lulus ujian skripsi</li>
      </ul>
