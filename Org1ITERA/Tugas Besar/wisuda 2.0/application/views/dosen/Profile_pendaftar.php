  ...
  <!---->
      ...
      <div class="row">
        <div class="col-sm-3">
            ...
            <div class="col-sm-12">
               <div class="list-group">
                  <ul style="list-style-type: none;">
                   ...
                   <li class="list-group-item"><a href="<?=base_url()?>index.php/wisuda/getListBimbingan" style="color: #555; text-decoration: none; display: block;">List Pendaftar Wisuda</a></li>
           ...
           <?php foreach($data as $value){?>
             ...
             <li class="list-group-item"><?php echo '<strong>Nim : </strong>'.  $value['nim']; ?></li>
              <li class="list-group-item">
               ...
               <li class="list-group-item"><?php echo '<strong>Sidang TA 1 : </strong>'.$value['sidangta_1'];?></li>
               <li class="list-group-item"><?php echo '<strong>Sidang TA 2 : </strong>'.$value['sidangta_2'];?></li>
               <a href="<?=base_url()?>index.php/wisuda/ubahBimbingan/<?php echo $value['nim']; ?>" class="btn btn-default" style="margin-top: 10px;"> Ubah</a>
               ...
               <?php }?>
                <?php if($button==1){?>
               <form method="post" action="<?=base_url()?>index.php/wisuda/UpdateValidasiBimbingan/<?php echo $value['nim']; ?>" class="form">
               <li class="list-group-item">
               ...
               <li class="list-group-item">
                 <STRONG>Sidang Tugas Akhir ke 1 : </STRONG>
                 <label class="checkbox-inline"><input type="checkbox" value="sudah" name="sidangta_1">Sudah</label>
                 <label class="checkbox-inline"><input type="checkbox" value="belum" name="sidangta_1">Belum</label>
               </li>
               </li>
               <li class="list-group-item">
                 <STRONG>Sidang Tugas Akhir ke 2 : </STRONG>
                 <label class="checkbox-inline"><input type="checkbox" value="sudah" name="sidangta_2">Sudah</label>
                 <label class="checkbox-inline"><input type="checkbox" value="belum" name="sidangta_2">Belum</label>
               </li>
               </li>
         ...
         <div class="col-sm-3">
         <?php foreach($data as $value){ ?>
            <a href="<?=base_url()?>index.php/wisuda/ValidasiBimbingan/<?php echo $value['nim'];?>" class="btn btn-default" style="margin-top: 10px;"> Validasi Mahasiswa</a>
            <?php if($valid==1){?>
