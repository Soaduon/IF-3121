        ...
        <div class="row">
         <table border="1" class="col-sm-12">
           <h3 style="text-align: left;">List Bimbingan : </h3>
         	...
         	<tr>
         		<td style="text-align: center;"><?php echo '<a href="'.base_url().'index.php/wisuda/getDataBimbingan/'.$value['nim'].'" style="color:#555; text-decoration:none; display:block;">'.$value['nama'].'</a>';?></td>
