...
<html lang="en">
  ...
  <body>
    ...
    <ul>
      ...
      <li><a href="<?=base_url()?>index.php/wisuda/panduan">Persyaratan</a></li>
      ...
      <li><a href="<?=base_url()?>index.php/wisuda/page_login">Login</a></li>
    </ul>
    </nav>
    </div>
  <!---->
      ...
      <div class="row content">
          <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/css/pengumuman.css">
              <div class="A">
                   <a href="<?=base_url()?>index.php/wisuda/wisudapertama_page" >
