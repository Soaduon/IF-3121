      ...
      <div class="row">
        ...
        <div class="row">
         <table border="1" class="col-sm-6">
           <h3 style="text-align: left;">List Pendaftar Wisuda : </h3>
         	...
         	<tr>
         		<td style="text-align: center;"><?php echo '<a href="'.base_url().'index.php/wisuda/getDataPendaftar/'.$value['nim'].'" style="color:#555; text-decoration:none; display:block;">'.$value['nama'].'</a>';?></td>
