        ...
        <div class="col-sm-3">
         ...
         <div class="col-sm-3">
             <ul style="list-style-type: none;  margin-top: 40px;">
              <li class="list-group-item"><a style="text-decoration: none; display: block; color:gray;" href="<?=base_url()?>index.php/wisuda/getValidasiPendaftar/<?php echo $value['nim']?>">Lihat Validasi Pendaftar</a></li>
             </ul>
        </div>
      </div>
      </div>
