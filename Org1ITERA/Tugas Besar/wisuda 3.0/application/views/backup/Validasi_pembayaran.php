...
<html lang="en">
  ...
  <!---->
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
        <div class="row">
          <form class="form" method="post" action="<?=base_url()?>index.php/wisuda/submit_bukti" style="margin-top: 20px;">
          <div class="form-group">
            <label for="Nama">Upload bukti pembayaran: </label>
            <input name ="Bukti_pembayaran" type="file" class="form-control">
          </div>
           <button type="submit" class="btn btn-info btn-lg" style="background-color: #DAA520; color:white;">Submit</button>
          </form>
        </div>
        </div> 
      </div>
