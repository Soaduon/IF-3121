...
<html lang="en">
  ...
  <body>
    ...
    <ul>
      ...
      <li><a href="<?=base_url()?>index.php/wisuda/panduan">Panduan Pendaftaran</a></li>
           ...
           <ul style="list-style-type: none;">
             ...
             <li class="list-group-item"><?php echo '<strong>Nim : </strong>'.  $nim; ?></li>
              <li class="list-group-item">
               ...
               <li>-Jika anda belum menyelesaikan kuliah praktik, kuliah kerja nyata, sidang tugas akhir 1 dan sidang tugas akhir 2 maka anda belum bisa mendaftar wisuda</li>
           </ul>
         </div>
        </div>
      </div>
