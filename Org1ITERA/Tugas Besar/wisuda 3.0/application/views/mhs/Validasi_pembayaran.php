...
<html lang="en">
  ...
  <!---->
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
        <div class="row">
        <div class="h4"> Upload bukti pembayaran :</div>
         <?php echo $error;?>
         <?php echo form_open_multipart('wisuda/submit_bukti/'.$nim);?>
        ...
        <div class="col-sm-6">
          <div class="h4"> <center>Validasi Pendaftaran Wisuda:</center> </div>
          <div class="list-group">
            <ul style="list-style: none;">
            <?php if($msg==1){ ?>
              <li class="list-group-item"><?php  if($bukti_pembayaran==NULL||$bukti_pembayaran==''){
                echo '<strong>Bukti pembayaran wisuda : </strong>'. 'belum';
                }else{
                   echo '<strong>Bukti pembayaran wisuda : </strong>'. 'sudah';
                  } ?></li>
               <li class="list-group-item"><?php echo '<strong>Validasi keuangan : </strong>'.  $validasi_keuangan ?></li>
               <li class="list-group-item"><?php echo '<strong>Validasi pembayaran : </strong>'.$validasi_pembayaran;?></li>
               <li class="list-group-item"><?php echo '<strong>Validasi dosen : </strong>'.$validasi_dosen;?></li>
            <?php }elseif($msg==0){ ?>
              <h3>Maaf anda belum mendaftar wisuda, haraf mendaftar wisuda dahulu untuk mengakses page ini.</h3>
              <?php }?>
            </ul>
          </div>
        </div> 
