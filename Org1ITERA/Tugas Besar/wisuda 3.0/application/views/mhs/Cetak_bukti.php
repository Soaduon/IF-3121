           ...
           <ul style="list-style: none;">
             ...
             <li class="list-group-item"><?php echo '<strong>Nim : </strong>'.  $value1['nim']; ?></li>
              <li class="list-group-item">
               ...
               <li class="list-group-item"><?php echo '<strong>Sidang TA 1 : </strong>'.$value1['sidangta_1'];?></li>
               <li class="list-group-item"><?php echo '<strong>Sidang TA 2 : </strong>'.$value1['sidangta_2'];?></li>
               <a href="<?php echo base_url().'index.php/wisuda/downloadbukti/'.$value1['nim']; ?>" class="btn btn-default" style="margin-top: 10px; background-color: #61d622; color: #FFF;">Download Bukti Validasi</a>
           </ul>
           </div>
         </div>
         <div class="col-sm-6">
           <div class="list-group">
             <ul style="list-style: none;">
              ...
              <li class="list-group-item"><?php echo '<strong>Validasi Pembayaran : </strong>'.  $data['validasi_pembayaran'] ?></li>
              <li class="list-group-item"><?php echo '<strong>Validasi Keuangan : </strong>'.  $data['validasi_keuangan'] ?></li>
              <?php }?>
             </ul>
           </div>
         </div>
